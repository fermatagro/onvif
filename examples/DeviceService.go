...
import (
	...
	goonvif "github.com/fermatagro/onvif"
	"github.com/fermatagro/onvif/device"
	sdk "github.com/fermatagro/onvif/sdk/device"
...
func main() {
	...
	if err != nil {
		...
		// You could use https://github.com/fermatagro/onvif/gosoap for pretty printing response
